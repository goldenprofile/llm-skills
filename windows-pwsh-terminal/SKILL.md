...
4. **Применяй** точечно, с комментариями в профиле и `.wezterm.lua`. Готовые команды/сниппеты — в [references/reference.md](references/reference.md).
...
Подробные команды и сниппеты — [references/reference.md](references/reference.md).
