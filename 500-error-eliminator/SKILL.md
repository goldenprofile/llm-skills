...
Это узкоспециализированный реактивный плейбук именно для Django 500. Произвольные
не-Django баги и регрессии производительности — вне scope; разбирай их обычным
дисциплинированным циклом reproduce → minimise → hypothesise → fix → regression-test.
...
воспроизведение ошибки локально приветствуется (дисциплинированный шаг reproduce).
