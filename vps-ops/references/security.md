...
Один VPS, прямой доступ к интернету, без выделенной команды эксплуатации. Базовый периметр:
не-root сервис, firewall, секреты вне репозитория, защищённый SSH. Без этого остальное неважно.
