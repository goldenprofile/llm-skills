...
| «Работает», а на деле нет | Нет автопроверки результата | test-writer, /verify, harness-engineering |
...
и режимами (см. таблицы выше). Встраивание LLM в собственный продукт (API,
стоимость, evals) — `llm-feature-architect`.
