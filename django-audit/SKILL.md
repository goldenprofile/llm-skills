...
name: django-audit
description: >
  Комплексный аудит Django-проекта по линзам: архитектура, безопасность
  (OWASP), Celery, чистота кода, техдолг, деплой, тесты. Django-специфичный
  разбор: ORM/N+1, шаблоны, settings, миграции. Используй когда пользователь
  просит аудит Django-проекта, проверить архитектуру/безопасность/Celery,
  найти техдолг, говорит «проверь Django проект», «django security review»,
  «готов ли к продакшену». Линза на выбор или полный аудит (all). Для
  фреймворк-независимого аудита с балльной оценкой — python-project-audit;
  для глубокого разбора тестов — test-coverage-auditor.
metadata:
  version: 1.1.0
---
