# Режим prompt — из разговорного описания в однозначное задание
...
Два полных примера трансформации (задача с неявным контекстом, задача с размытыми требованиями) — в [prompt-examples.md](prompt-examples.md). Читай их когда нужен образец готового промта по этой методике.
