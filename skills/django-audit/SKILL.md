...
name: django-audit
description: >
  Разбор Django-проекта по одной выбранной линзе: ORM и N+1, безопасность
  (OWASP), Celery, шаблоны, settings, миграции, техдолг, тесты — находки по
  уровням риска и план. Используй когда пользователь просит «экспресс-анализ
  кодовой базы на N+1 и анти-паттерны», «собери весь техдолг», «проверь
  Django проект», «django security review», или сам называет линзу. Балльная
  оценка готовности всего бэкенда — python-project-audit; понять устройство
  без приговора — codebase-recon; глубокий разбор тестов —
